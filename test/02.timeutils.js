...
describe('Julian Day', _ => {

  const cases = [
		{ year:  1984, month:  8, day: 29  , djd: 30921.5 },
		{ year:  1899, month: 12, day: 31.5, djd: 0 },
		{ year:  1938, month:  8, day: 17  , djd: 14107.5 },
		{ year:  1,    month:  1, day:  1  , djd: -693596.5 },
	    { year: -4713, month:  7, day: 12  , djd: -2414827.5 },
		{ year: -4713, month:  1, day:  1.5, djd: -2415020 },
  ];
...
describe('Sidereal Time', _ => {
  const cases = [
    ...
    {djd: 29332.108931, lst: 4.668119, utc: 14.614353, ok: true}, // 1980-04-22.6
  ];
