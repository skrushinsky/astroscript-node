...
describe('Fractional part of a number', _ => {
...
describe('Ranges', _ => {
  ...
  let deg_cases = [
      [20, -700], [0, 0], [345, 345], [340, 700], [0, 360], [70.45, 324070.45]
  ];
  ...
  let rad_cases = [
    [0.323629385640829, 12.89], [5.95955592153876, -12.89], [0, 0], [3.71681469282041, 10.0],
    [Math.PI, Math.PI], [0, mathutils.PI2]
  ];
