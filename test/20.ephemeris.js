...
describe('True geocentric', _ => {
    const cases = [
        { planet : 'Mercury', geo : [275.88530,  1.47425,  0.98587] },
        { planet : 'Venus',   geo : [264.15699,  1.42582,  1.22905] },
        { planet : 'Mars',    geo : [214.98173,  1.67762,  1.41366] },
        { planet : 'Jupiter', geo : [270.30024,  0.29758,  6.10966] },
        { planet : 'Saturn',  geo : [225.37862,  2.33550, 10.04942] },
        { planet : 'Uranus',  geo : [252.17354,  0.05160, 19.63393] },
        { planet : 'Neptune', geo : [270.07638,  1.16314, 31.11160] },
        { planet : 'Pluto',   geo : [212.07989, 16.88244, 29.86118] },
    ];
...
describe('True geometric positions, Duffett-Smith examples', _ => {
    const djd = 30830.5; // 1984 May 30
    const eph = new Ephemeris(djd);
    const cases = [
      { name: 'Mercury', helio: {l: mathutils.radians(-34.7722), b: mathutils.radians(-6.95147), r: 0.401741 },
                         geo:   {l: mathutils.radians(45.9319),  b: mathutils.radians(-2.78797), d: 0.999897 }},
      { name: 'Saturn',  helio: {l: mathutils.radians(223.9315), b: mathutils.radians(2.33025), r: 9.865601 },
                         geo:   {l: mathutils.radians(221.2009), b: mathutils.radians(2.56691), d: 8.956587 }},
    ];
...
describe('Sun position', _ => {
    ...
    for (let c of cases) {
        ...
        //it(`${c.djd}: apparent longitude`, () => {
        //    assert.approximately(mathutils.degrees(got.geo.l), c.ap, 1E-3);
        //});
    }
});


describe('Daily motion', _ => {
    const cases = [
        { name: 'Moon'   , motion: 14.0721 },
        { name: 'Sun'    , motion:  0.9560 },
        { name: 'Mercury', motion:  0.0344 },
        { name: 'Venus'  , motion:  0.9132 },
        { name: 'Mars'   , motion:  0.6832 },
        { name: 'Jupiter', motion:  0.1600 },
        { name: 'Saturn' , motion: -0.0669 },
        { name: 'Uranus' , motion:  0.0336 },
        { name: 'Neptune', motion: -0.0001 },
        { name: 'Pluto'  , motion: -0.0223 }
    ];
